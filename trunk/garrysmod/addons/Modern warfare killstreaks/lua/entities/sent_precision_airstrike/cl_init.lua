...
local function DrawPrecisionMarker()
	...
	surface.SetDrawColor(255,255,255,255) //Makes sure the image draws correctly
	DrawArrow(LocalPlayer():GetNetworkedInt("AirstrikeMarkerAngle"));
	return true;
end
...
local function drawHud()
	hook.Add("HUDPaint","DrawPrecisionMarker",DrawPrecisionMarker)
end
local function removeHud()
	hook.Remove("HUDPaint","DrawPrecisionMarker")
end

usermessage.Hook("Precision_Strike_SetUpHUD", drawHud)
usermessage.Hook("Precision_Strike_RemoveHUD", removeHud)